...
class Hero: Namable {
    ...
    static let baron = Hero(name: "Baron", HPLow: 814, HPHigh: 1672, armorLow: 30, shieldLow: 30, weaponPowerLow: 71, weaponPowerHigh: 108, attackSpeedHigh: 1.22, moveSpeed: 2.6, weaponPowerModifier: 1.25, attackSpeedModifier: 0.6, attackCooldown: 1.5)
    ...
    static let flicker = Hero(name: "Flicker", HPLow: 807, HPHigh: 1654, armorLow: 25, armorHigh: 85, shieldLow: 25, shieldHigh: 85, weaponPowerLow: 77, weaponPowerHigh: 155, attackSpeedHigh: 1.36, moveSpeed: 3.5)
    ...
    static let grace = Hero(name: "Grace", HPLow: 748, HPHigh: 1452, weaponPowerLow: 79, weaponPowerHigh: 158, attackSpeedHigh: 1.36, moveSpeed: 3.7)
